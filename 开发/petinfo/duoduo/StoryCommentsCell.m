...
-(void)layoutSubviews{
    ...
    CGSize size = [str boundingRectWithSize:CGSizeMake(ScreenWidth - 40, 0) options:NSStringDrawingTruncatesLastVisibleLine | NSStringDrawingUsesLineFragmentOrigin | NSStringDrawingUsesFontLeading attributes:@{NSFontAttributeName:FONT(13)} context:nil].size;
