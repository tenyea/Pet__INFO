...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    EquipCell *cell =(EquipCell *) [tableView dequeueReusableCellWithIdentifier : equipIdentifier];

    
    if (cell == nil) {
        cell = [[[NSBundle mainBundle] loadNibNamed:@"EquipCell" owner:self options:nil] lastObject];
    }
