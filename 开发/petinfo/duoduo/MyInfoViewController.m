...
- (void)viewDidLoad
{
    ...
    _userDic = [[NSUserDefaults standardUserDefaults]objectForKey:UD_userInfo_DIC];
...
//        <#statements#>
//    }
    _tableView = [[UITableView alloc]initWithFrame:CGRectMake(0, 66, ScreenWidth , 44* ([_array count] - 1) + headImageHeigh) style:UITableViewStylePlain];
